package com.aventurayturismo.at.fragments.naturaleza;
 ...
 * Use the {@link naturalezaFragment#newInstance} factory method to
...
public class naturalezaFragment extends Fragment {
    ...
    public naturalezaFragment() {
        // Required empty public constructor
    }

    public static naturalezaFragment newInstance() {
        naturalezaFragment fragment = new naturalezaFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_naturaleza, container, false);
        ...
        RecyclerView recycler = (RecyclerView)v.findViewById(R.id.naturlezaRecycler);

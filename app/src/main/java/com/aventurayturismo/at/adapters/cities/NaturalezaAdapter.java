...
public class NaturalezaAdapter extends RecyclerView.Adapter<NaturalezaAdapter.NaturalezaViewHolder>{
    private ArrayList<Naturaleza> items;
    Context context;
    ...
    public class NaturalezaViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public NaturalezaViewHolder (View v){
            super(v);
    ...
    public NaturalezaAdapter(ArrayList<Naturaleza> items){
        this.items = items;
    }
    ...
    @Override
    public NaturalezaAdapter.NaturalezaViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.naturaleza_card, viewGroup, false);
        return new NaturalezaAdapter.NaturalezaViewHolder(v);
    }

    @Override
    public void onBindViewHolder(NaturalezaAdapter.NaturalezaViewHolder viewHolder, int i) {
        Naturaleza currentItem = items.get(i);
